...
with mx_sales:
    ...
    curr_sales = data.loc[data['order_year']==CURR_YEAR, 'sales'].values[0] # mengambil baris dari dataframe yg mana thn 2017 yg diambil yg sales
...
with mx_order:
    ...
    curr_order = data.loc[data['order_year']==CURR_YEAR, 'order_id'].values[0] # mengambil baris dari dataframe yg mana thn 2017 yg diambil yg sales
...
with mx_customer:
    ...
    curr_customer = data.loc[data['order_year']==CURR_YEAR, 'customer_id'].values[0] # mengambil baris dari dataframe yg mana thn 2017 yg diambil yg sales
